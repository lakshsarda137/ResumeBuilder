...
export const RESUME_BUILD_TEMPLATES: ResumeBuildStyleProfile[] = [
  {
    ...
    pageBudget: 'Hard one-page resume. Prefer 5-6 total entries, 12-16 bullets total, and compact skills. Never produce content likely to exceed one page.',
    ...
    selectionRules: [
      ...
      'Use at most 2-3 bullets for normal entries and at most 4 bullets for the strongest entry.',
    ...
    formattingRules: [
      ...
      'Do not list a tech stack beside every item unless the source has a real, relevant stack and it helps scanning.',
      'If using inline emphasis in JSON strings, use only <strong>, <em>, or <span style="font-weight:...;font-style:..."> for heading/keyword conventions; do not output Markdown.',
    ],
    contactRules: [
  ...
  },
  {
    ...
    formattingRules: [
      ...
      'Avoid tech-stack subtitles unless they materially improve scanability.',
    ],
    contactRules: [
  ...
  {
    id: 'technical',
    name: 'Tech-stack forward',
    summary: 'One-page resume with stack cues beside substantial entries.',
    font: 'Times-style serif, concise technical subtitles.',
    pageBudget: 'Hard one-page resume. Use 5-6 entries, 12-15 bullets total, and compact stack-heavy subtitles.',
    sectionOrder: ['Education', 'Experience', 'Projects', 'Technical Skills'],
    selectionRules: [
      ...
      'Limit weaker entries to one bullet or omit them.',
    ],
    formattingRules: [
      'List concise tech stacks in subtitles for experiences/projects only when the source supports them.',
      'Keep stack lists short: 4-7 technologies, no padding.',
      'Allow the LLM to bold the most important 1-3 technical keywords per section if useful.',
      'Use <strong> for selected keywords, <em> for subtitles/date-style context, and restricted <span style="font-weight:...;font-style:..."> only when custom conventions require heading/label styling; do not output Markdown.',
